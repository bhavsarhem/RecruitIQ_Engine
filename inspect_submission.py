...
base = r'd:\RecruitIQ_Engine\[PUB] India_runs_data_and_ai_challenge\India_runs_data_and_ai_challenge'
cand_lookup = {}
...
# Check v3 (weighted baseline) top 15
print("=== submission_v3.csv (Weighted baseline) TOP 15 ===")
with open(r'd:\RecruitIQ_Engine\recruitiq-engine\submission_v3.csv', newline='', encoding='utf-8') as f:
